...
public class QuickStatusBarHeader extends RelativeLayout implements
    ...
    public QuickStatusBarHeader(@Named(VIEW_CONTEXT) Context context, AttributeSet attrs,
            ...
            ActivityStarter activityStarter, CommandQueue commandQueue, PrivacyItemController privacyItemController,
            RingerModeTracker ringerModeTracker, UiEventLogger uiEventLogger, BroadcastDispatcher broadcastDispatcher) {
        super(context, attrs);
