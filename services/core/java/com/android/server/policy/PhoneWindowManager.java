...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void powerPress(long eventTime, int count, int displayId, boolean beganFromNonInteractive) {
    ...
    private final class PowerKeyRule extends SingleKeyGestureDetector.SingleKeyRule {
        ...
        void onPress(long downTime, int displayId) {
            ...
            powerPress(downTime, 1 /*count*/, displayId, mSingleKeyGestureDetector.beganFromNonInteractive());
        }
        ...
        void onMultiPress(long downTime, int count, int displayId) {
            ...
            powerPress(downTime, count, displayId, mSingleKeyGestureDetector.beganFromNonInteractive());
        }

        @Override
        void onKeyUp(long eventTime, int count, int displayId) {
            if (mShouldEarlyShortPressOnPower && count == 1) {
                powerPress(eventTime, 1 /*pressCount*/, displayId, mSingleKeyGestureDetector.beganFromNonInteractive());
            }
        }
    }
